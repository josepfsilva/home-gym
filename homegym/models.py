...
def add_training_plan():
    ...
    #user1
    cursor.execute("INSERT OR IGNORE INTO TrainingPlan (Name, Description, Type, PlanDuration, TrainImage,ExercisePlanID, UserID) VALUES ('Treino de parte superior', 'Este plano visa a trabalhar a parte superior do corpo.', 'Musculacao', 90, 'static\\img\\upper-body.jpg' ,1, 1);")
    cursor.execute("INSERT OR IGNORE INTO TrainingPlan (Name, Description, Type, PlanDuration, TrainImage,ExercisePlanID, UserID) VALUES ('Treino de parte inferior', 'Este plano visa a trabalhar a parte inferior do corpo.', 'Musculacao', 90,'static\\img\\lower-body.jpg', 3, 1);")
    cursor.execute("INSERT OR IGNORE INTO TrainingPlan (Name, Description, Type, PlanDuration, TrainImage,ExercisePlanID, UserID) VALUES ('Treino de cardio', 'O objetivo deste plano é aumentar a resistencia.', 'Cardio', 90, 'static\\img\\cardio.jpg',5, 1);")
    cursor.execute("INSERT OR IGNORE INTO TrainingPlan (Name, Description, Type, PlanDuration, TrainImage,ExercisePlanID, UserID) VALUES ('Meditacao', 'Este plano tem como objetivo promover o relaxamento e a saúde mental.', 'Meditacao', 90, 'static\\img\\meditation.jpg',7, 1);")
    cursor.execute("INSERT OR IGNORE INTO TrainingPlan (Name, Description, Type, PlanDuration, TrainImage,ExercisePlanID, UserID) VALUES ('Alongamentos membros superiores', 'A finalidade deste plano é melhorar a flexibilidade e aliviar a tensão muscular dos membros superiores.', 'Musculacao', 90, 'static\\img\\upper-stretches.jpg',8, 1);")
    cursor.execute("INSERT OR IGNORE INTO TrainingPlan (Name, Description, Type, PlanDuration, TrainImage ,ExercisePlanID, UserID) VALUES ('Alongamentos membros inferiores', 'A finalidade deste plano é melhorar a flexibilidade e aliviar a tensão muscular dos membros inferiores', 'Musculacao', 90, 'static\\img\\lower-stretches.jpg',10, 1);")

    #user2
    cursor.execute("INSERT OR IGNORE INTO TrainingPlan (Name, Description, Type, PlanDuration, TrainImage ,ExercisePlanID, UserID) VALUES ('Treino de parte superior', 'Este plano visa a trabalhar a parte superior do corpo.', 'Musculacao', 90, 'static\\img\\upper-body.jpg',2, 2);")
    cursor.execute("INSERT OR IGNORE INTO TrainingPlan (Name, Description, Type, PlanDuration, TrainImage ,ExercisePlanID, UserID) VALUES ('Treino de parte inferior', 'Este plano visa a trabalhar a parte inferior do corpo.', 'Musculacao', 90, 'static\\img\\lower-body.jpg',4, 3);") #changed user to 3 to test
    cursor.execute("INSERT OR IGNORE INTO TrainingPlan (Name, Description, Type, PlanDuration, TrainImage ,ExercisePlanID, UserID) VALUES ('Treino de cardio', 'O objetivo deste plano é aumentar a resistencia.', 'Cardio', 90, 'static\\img\\cardio.jpg',6, 2);")
    cursor.execute("INSERT OR IGNORE INTO TrainingPlan (Name, Description, Type, PlanDuration, TrainImage ,ExercisePlanID, UserID) VALUES ('Meditacao', 'Este plano tem como objetivo promover o relaxamento e a saúde mental.', 'Meditacao', 90, 'static\\img\\meditation.jpg', 7, 2);")
    cursor.execute("INSERT OR IGNORE INTO TrainingPlan (Name, Description, Type, PlanDuration, TrainImage ,ExercisePlanID, UserID) VALUES ('Alongamentos membros superiores', 'A finalidade deste plano é melhorar a flexibilidade e aliviar a tensão muscular dos membros superiores.', 'Musculacao', 90,'static\\img\\upper-stretches.jpg', 9, 2);")
    cursor.execute("INSERT OR IGNORE INTO TrainingPlan (Name, Description, Type, PlanDuration, TrainImage ,ExercisePlanID, UserID) VALUES ('Alongamentos membros inferiores', 'A finalidade deste plano é melhorar a flexibilidade e aliviar a tensão muscular dos membros inferiores', 'Musculacao', 90,'static\\img\\lower-stretches.jpg', 11, 2);")
