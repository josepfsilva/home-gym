...
def add_exercises():
    ...
    cursor.execute("INSERT OR IGNORE INTO Exercises (Name, Description, URL, ExerciseImg, Type, Difficulty) VALUES ('Abdominais', 'Um exercício de corpo inteiro que trabalha o core.', 'https://www.youtube.com/watch?si=C5-pw4YcjozxcHf0&v=NnVhqMQRvmM&feature=youtu.be','static\\img\\abs.jpg' , 'Musculacao', 'Easy');")
    ...
    # lower body
    cursor.execute("INSERT OR IGNORE INTO Exercises (Name, Description, URL, ExerciseImg ,Type, Difficulty) VALUES ('Agachamentos', 'Um exercício composto que trabalha os quadríceps, isquiotibiais e glúteos.', 'http://example.com/squats', 'static\\img\\squat.jpg' ,'Musculacao', 'Medium');")
    cursor.execute("INSERT OR IGNORE INTO Exercises (Name, Description, URL, ExerciseImg ,Type, Difficulty) VALUES ('Lunges', 'Um exercício de perna que trabalha os quadríceps e glúteos.', 'http://example.com/lunges', 'static\\img\\lunge.jpg' ,'Musculacao', 'Easy');")
    cursor.execute("INSERT OR IGNORE INTO Exercises (Name, Description, URL, ExerciseImg ,Type, Difficulty) VALUES ('Agachamentos com salto', 'Um exercício de perna que trabalha os quadríceps e glúteos.', 'http://example.com/jump-squats', 'static\\img\\jumpsquat.jpg' ,'Musculacao', 'Hard');")
