    ...
    fetch('http://127.0.0.1:5000/planos') 
                ...
                .then(data => { 
                    ...
                    for (var planId in plans) {
                        ...
                        html += '<div class="container"> <div class="content"> <img src=' + planDetails[4] + ' class="meusplanosimg" > <div class="text-overlay"> <h3>'+ planDetails[0]+'</h3> <p> Plano '+ planOrder +' </p></div> </div> </div>'
